    ...
    <section className="px-15 my-grid lg:mb-228">
      ...
      >
        ...
        >
          ...
          &ldquo;FCC
          学员的去向,是我们最真实的成绩单。从战略咨询到投资银行,从头部互联网大厂到前沿
          AI
          公司,学员的每一份录用背后,都是背景诊断、导师指导与多轮实战模拟的长期积累。我们坚持信息透明、结果导向,陪伴每一位学员走到
          Offer 的那一刻。&rdquo;
        </div>
        <footer className="mt-100 flex items-center gap-x-15 lg:mt-44">
          ...
          <cite ref={citeRef} className="text-blue not-italic">
            <div className="page-text lg:fs-20">徐天石</div>
            <div className="text-mono fs-12 mt-8">CONSULTING PARTNER</div>
          </cite>
        </footer>
      </blockquote>
    </section>
